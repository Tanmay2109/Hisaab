...
export const BottomNav: React.FC<BottomNavProps> = ({
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-40 block border-t border-[#e2e2d8] bg-[#f5f5f0]/95 backdrop-blur-md dark:border-[#33332c] dark:bg-[#1a1a17]/95 lg:hidden shadow-lg pb-[env(safe-area-inset-bottom)]">
