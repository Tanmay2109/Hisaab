...
export const Navbar: React.FC<NavbarProps> = ({
  ...
  return (
    <header className="sticky top-0 z-30 flex h-16 w-full items-center justify-between border-b border-[#e2e2d8] bg-[#f5f5f0]/95 px-3 backdrop-blur-md dark:border-[#33332c] dark:bg-[#1a1a17]/95 sm:px-6">
      ...
      <div className="flex items-center gap-1.5 sm:gap-3">
        {/* Quick Entry Button (Desktop only) */}
        <button
          onClick={openAIModal}
          className="hidden md:inline-flex items-center gap-1.5 rounded-xl bg-[#5A5A40] px-3 py-2 text-xs font-semibold text-white transition hover:bg-[#484832] shadow-xs"
        >
          <Plus className="h-4 w-4 text-[#e6e6dc]" />
