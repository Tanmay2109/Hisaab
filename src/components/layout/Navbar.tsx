...
export const Navbar: React.FC<NavbarProps> = ({
  ...
  return (
    <header className="sticky top-0 z-30 flex h-16 items-center justify-between border-b border-[#e2e2d8] bg-[#f5f5f0]/95 px-3 backdrop-blur dark:border-[#33332c] dark:bg-[#1a1a17]/95 sm:px-6">
      <div className="flex items-center gap-2 sm:gap-3">
        <button
          onClick={toggleSidebar}
          className="rounded-lg p-1.5 text-[#66665c] hover:bg-[#e6e6dc] dark:text-[#a3a395] dark:hover:bg-[#2a2a25] lg:hidden"
        ...
        <div
          ...
          className="flex cursor-pointer items-center gap-2 font-bold tracking-tight text-[#33332d] dark:text-[#e5e5dc]"
        >
          <div className="flex h-8 w-8 items-center justify-center rounded-xl bg-gradient-to-tr from-[#5A5A40] to-[#526352] text-white shadow-xs sm:h-9 sm:w-9">
            <Wallet className="h-4 w-4 sm:h-5 sm:w-5" />
          </div>
          <div className="flex flex-col">
            <span className="text-lg font-extrabold tracking-tight text-[#33332d] dark:text-[#e5e5dc] sm:text-xl">
              Hisaab
            </span>
      ...
      <div className="flex items-center gap-1.5 sm:gap-3">
        ...
        <button
          onClick={openAIModal}
          className="inline-flex items-center gap-1.5 rounded-xl bg-[#5A5A40] px-2.5 py-1.5 text-xs font-semibold text-white transition hover:bg-[#484832] sm:px-4 sm:py-2.5 sm:text-sm shadow-xs"
        >
          <Sparkles className="h-3.5 w-3.5 animate-pulse text-[#e6e6dc] sm:h-4 sm:w-4" />
        ...
        <div className="relative">
          <select
            ...
            className="rounded-lg border border-[#e2e2d8] bg-[#fafaf6] py-1 px-1.5 text-[11px] font-medium text-[#33332d] shadow-2xs transition hover:bg-[#e6e6dc] dark:border-[#33332c] dark:bg-[#242420] dark:text-[#e5e5dc] dark:hover:bg-[#2a2a25] sm:py-1.5 sm:px-2 sm:text-sm"
          >
            {currencies.map((c) => (
