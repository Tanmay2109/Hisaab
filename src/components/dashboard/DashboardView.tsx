  ...
  return (
    <div className="space-y-6">
      ...
      {upcomingBills.length > 0 && (
        <div className="flex flex-col sm:flex-row gap-3 sm:items-center justify-between rounded-2xl border border-[#e5c2a1] bg-[#fdf8eb] p-4 dark:border-[#332b1a] dark:bg-[#282115]">
          <div className="flex items-center gap-3">
            <div className="rounded-xl bg-[#d99b26]/20 p-2 text-[#8a7051] dark:text-[#d99b26] shrink-0">
          ...
          <button
            ...
            className="rounded-xl bg-[#5A5A40] px-3 py-1.5 text-xs font-bold text-white hover:bg-[#484832] transition shrink-0 self-start sm:self-auto"
          >
            View Bills
          </button>
        </div>
