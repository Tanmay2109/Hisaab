  ...
  return (
    <div className="min-h-screen bg-[#f5f5f0] text-[#33332d] dark:bg-[#1a1a17] dark:text-[#e5e5dc]">
      ...
      <div className="flex">
        ...
        <main className="flex-1 p-3 pb-24 sm:p-6 lg:p-8 lg:pb-8 max-w-7xl mx-auto w-full">
          {activeTab === 'dashboard' && (
            <DashboardView
              accounts={accounts}
      ...
      {showAIModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-[#33332d]/60 p-4 backdrop-blur-xs">
          <div className="w-full max-w-lg max-h-[90vh] overflow-y-auto rounded-2xl border border-[#e2e2d8] bg-white p-5 sm:p-6 shadow-2xl dark:border-[#33332c] dark:bg-[#242420]">
      ...
      {toast && (
        <div className="fixed bottom-20 lg:bottom-6 right-4 left-4 sm:left-auto sm:right-6 sm:w-auto z-50 flex items-center justify-between sm:justify-start gap-2 rounded-2xl border px-4 py-3 text-xs font-bold shadow-2xl transition-all duration-300 animate-in fade-in slide-in-from-bottom-5 bg-white text-[#33332d] border-[#e2e2d8] dark:bg-[#242420] dark:text-[#e5e5dc] dark:border-[#33332c]">
